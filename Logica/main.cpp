                ...
                if (event.type == sf::Event::KeyPressed) {
                    if (event.key.code == sf::Keyboard::Up) {
                        ...
                        if (seleccionados.size() == 3) {
                            ...
                            switch (seleccion) {
                                case 0: tanqueParaColocar = new TanquePesado(idTanque++); break;
                                case 1: tanqueParaColocar = new TanquePesado(idTanque++); break;
...
void seleccionarTanquesIA(
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        switch (tipo) {
            case 0: nuevoTanque = new TanquePesado(idTanque++); break;
            case 1: nuevoTanque = new TanquePesado(idTanque++); break;
...
int main() {
    ...
    /*while (temp != nullptr && !tanquesJugador.empty()) {
        if (temp->getTanque() == nullptr) {
            temp->setTanque(tanquesJugador.top());
            tanquesJugador.pop();
        }
        temp = temp->getSiguiente();
    }*/
    ...
    desplegarTablero(window, font, filas, columnas, cellSize, tableroPosiciones,
                     texturaTerreno1, texturaTerreno2, texturaTerreno3, texturaTanque);
